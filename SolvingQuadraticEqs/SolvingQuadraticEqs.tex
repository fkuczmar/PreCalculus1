...
\[
   x^2 + 9x + 9x = 3.
\]
The reason for doing this is to interpret the left side as the sum of three areas - one square with dimensions  $x\times x$ and two rectangles with dimensions $9\times x$. See the picture below.
