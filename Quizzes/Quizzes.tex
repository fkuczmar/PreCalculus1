...
Explain your reasoning. Define, with units, any variables you introduce. Include a picture to help with your explanation.
...
\[
        x^2 + y^2 +6x - 4y = 7 .      %        (x+3)^2 + (y-2)^2 = 20
\]
Draw a picture to help with your explanation.

\begin{hint}
Start by completing the square to find the center and radius of the given circle. For completing the square, see Example 23 in the Circles chapter of our class notes :

\href{https://ximera.osu.edu/precalc1/PreCalculus1/Circles/Circles}{Circles}
\end{hint}
\end{question}
