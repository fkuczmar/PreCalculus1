...
(a) By the Pythagorean theorem, the circle has radius 
\[
       \text{dist}(A,B) = \sqrt{(3-(-7))^2 + (2-(-3))^2} = \sqrt{41} .
\]

The circle is the set of points exactly $\sqrt{41}$ units from the center $A(-3,2)$. So a point $P$ with coordinates $(x,y)$ lies on the circle if and only if 
\[
