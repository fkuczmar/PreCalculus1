...
\begin{example} \label{Ex4:LF}
Suppose that over a certain interval of speeds, the speed of a car is a linear function of its gas mileage. 

\pskip

Choose speeds for the endpoints of this interval and reasonable gas mileages for those speeds. Then find a function that expresses the {\bf speed in terms of the gas mileage} by following the steps in Example 3.
\end{example}
