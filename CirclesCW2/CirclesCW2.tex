...
\item Drag point $R$ to approximate the coordinates of the point on the circle that is farthest from $B$. Then mark that position by dragging point $Q$ there.
...
\item Drag point $R$ in the worksheet below to approximate the coordinates of the point on the circle of radius $5$ centered at the point $A(5,-1)$ that is closest to the point $B$ with coordinates $(-2,3)$. Then mark that position by dragging point $P$ there.
