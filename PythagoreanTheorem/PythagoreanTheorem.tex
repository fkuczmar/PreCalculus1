...
Imagine a $5$-km long railroad track secured only at its two ends to the desert floor. Suppose on a hot day the track expands one meter and buckles into a curve. We would like to compute, or at least approximate, the height of the track above the ground in the middle. We really need calculus to determine the shape of the curve and the exact height, but we can get a pretty good approximation by supposing the track bends into two straight segments running from the high point to its endpoints.
