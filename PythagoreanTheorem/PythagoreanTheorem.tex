...
\item Our conclusion is that if the length of a pinned track increases by $\answer{0.02}\%$, it buckles to a height of approximately  $\answer{1}\%$ of its original length.
