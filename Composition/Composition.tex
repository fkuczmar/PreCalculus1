...
\item Solve the equation $f(g(x)) = 3$.

\item Solve the equation $g(f(x))=1$.

\item Solve the equation $f(f(x)) = 5$.

\item Solve the equation $g(g(x)) = 0$.

\item Solve the inequality $f(x)>2$.

\item Solve the inequality $f(x)<6$.

\item Solve the inequality $g(x)<0$.

\item Solve the inequality $f(g(x))\geq 3$.

\item Solve the equation $g(x)=x$.

\item Solve the equation $f(x)=2 - 3(x-3)$.

\item Solve the equation $g(x) = 4+(x-3)$.
...
\[
    f(f(x)) = 5 .
\]
Start by making the substitution $u=f(x)$ to hide the composition.
...
\item Use the graph of $y=f(x)$ above to evaluate $f(f(5))$. 
...
\[
    f(f(x))=c
\]
has \emph{exactly} three solutions. Explain your reasoning. Start by making the substitution $u=f(x)$ to hide the composition.

\item Use the graph of $y=f(x)$ above to approximate the domain of the composition $f\circ f$. Then use algebra to find the exact domain.
