...
Use the graphs of the functions $y=f(x)$ and $y=g(x)$ below to find approximate answers to the following questions. Use set notation to write solution sets when solving an equation.
