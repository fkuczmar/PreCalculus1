...
\section{Questions Without Functions}

\begin{question} \label{Q9dfrDFDf}
A colony of bacteria has a population of $200,000$ at 1:00pm and a population of $350,000$ at 2:00pm. Suppose the population increases exponentially.

\begin{enumerate}
\item Describe the exponential growth.

\item Find the population one hour after there are $800,000$ bacteria.

\item Find the population one hour before there are $800,000$ bacteria.

\item Find the population two hours after there are $800,000$ bacteria.
\end{enumerate}
\end{question}

\begin{question} \label{Qdfelgl43zzz}
A colony of bacteria has a population of $200,000$ at 1:00pm and a population of $450,000$ at 3:00pm. Suppose the population increases exponentially.

\begin{enumerate}
\item Describe the exponential growth.

\item Find the population two hours after there are $500,000$ bacteria.

\item Find the population two hours before there are $630,000$ bacteria.

\item Find the population at 2:00pm.

\item Find the population one hour after there are $900,000$ bacteria.

\item Find the population one hour before there are $900,000$ bacteria.

\end{enumerate}
\end{question}


\begin{question} \label{Qkffff3vfd}
Between noon and 10pm the population of a colony of bacteria grows exponentially. There are 200,000 bacteria at 1:00pm and  300,000 bacteria at 5:00pm.

\begin{enumerate}
\item Find the four-hour growth factor.

\item Find the exact (no calculator) one-hour growth factor.

\item Find the exact population at 8:00pm. Explain your thinking. No calculator.

\item Find a function 
\[
      P = f(t) \, , \, 0 \leq t \leq 10 ,
\]
that expresses the population in terms of the number of hours past noon. Explain the logic behind your function.
\end{enumerate}
\end{question}
...
We should check our function by evaluating $g(1)$ and $g(4)$. I'll leave this to you.
