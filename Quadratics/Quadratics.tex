...
(c) Find the domain of the composition $u\circ f$. Write it as a set.

(d) Use the graph of the function $f$ above to sketch a graph of the function $T= u(f(t))$.

(e) Simplify the composition $T=u(f(t))$ alegebraically. Then find a piecewise-defined equivalent form of the composition.

(f) Find the inverse of the function $u$.
