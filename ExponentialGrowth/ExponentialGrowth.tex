...
\]
that express the population (measured in hundreds of thousands of bacteria) in terms of the number of hours past noon assuming the population grows a constant rate (the function $f$) and at a constant relative rate (the function $g$), respectively. Use point-slope for $f$.
...
\href{https://www.desmos.com/calculator/wmitm72ut7}.
}
 
\begin{onlineOnly}
    \begin{center}
\desmos{wmitm72ut7}{900}{600}
\end{center}
\end{onlineOnly}
