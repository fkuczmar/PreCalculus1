...
\]
that express the population (in hundreds of thousands) in terms of the number of hours past noon assuming the population grows a constant rate (the function $f$) and at a constant relative rate (the function $g$), respectively.
...
\href{https://www.desmos.com/calculator/ijitjrucp8}.
}
 
\begin{onlineOnly}
    \begin{center}
\desmos{ijitjrucp8}{900}{600}
\end{center}
\end{onlineOnly}

\pskip

(b) Repeat part (a) assuming the population is $a\times 10^5$ at 1pm and $b\times 10^5$ at 4pm. Then vary the sliders for $a$ and $b$ and describe how the graphs change.  

(c) For part (b), find fully-simplified expressions (in terms of $a$ and $b$) for the populations at 2:30pm.
