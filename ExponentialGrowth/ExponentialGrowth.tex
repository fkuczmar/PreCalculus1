...
\item At what rate does the population grow?

The population increases at the constant rate of ...
...
\begin{enumerate}
\item Use common sense (do not rely on a formula) to evalute $f(8)$. Show the complete computation. Include units for every number. Explain your reasoning.

\item Use the same reasoning to find an expression for the function $P=f(t)$. Explain your reasoning.
\end{enumerate}
