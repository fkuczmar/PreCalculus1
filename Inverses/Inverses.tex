...
(a) At what rate (in gal/hour) does the car burn gas at a speed of $50$ miles/hour?

(b) Find a function 
\[
     r=h(v) , \,\, 50\leq v \leq 78 ,
\]
that expresses the rate at which the car burns gas (in gal/hour) in terms of its speed (in miles/hour).
...
(g) What should you get if you simplified the composition $h(h^{-1}(G))$? Explain your reasoning.

(h) Simplify the composition $h(h^{-1}(G))$ algebraically. Show all steps.
