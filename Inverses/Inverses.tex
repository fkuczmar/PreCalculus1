...
Desribe in words the inverses of each of the following.
...
(f) the action of squaring a positive number

(g) the action of squaring a negative number

(h) the action of subtracting the square of a positive number from 25 and then taking the square root of the result

(i) the action of subtracting the square of a negative number from 25 and then taking the square root of the result
\end{example}
