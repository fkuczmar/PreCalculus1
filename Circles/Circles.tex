...
(b) Suppose now $P$ has coordinates $(x,y,z)$ and translate your sentence from part (b) into an equation. Then simplify this equation.
...
Start by finding an equation of the set of points
\end{question}
