...
(a) Solve the equation of the line through the points of intersection for $y$ in terms of $x$. Then substitute this expression into the equation
\[
   x^2 + y^2 = 25
\]
of the first circle to get a quadratic equation. Solve this resulting equation for $x$ by \emph{completing the square}. Do \emph{not} use the quadratic formula.
...
The key is to find the centers of all such circles. The point $P$ with coordinates $(x,y)$ is the center of a circle through $A(3,5)$ and $B(6,-2)$ with radius $\sqrt{145}$  if and only if 

(a) $P$ is equidistant from $A$ and $B$, and

(b) the distance from $P$ to $A$ is equal to $\sqrt{145}$.

\pskip

As in Example 7, the first condition tells us that $P$ lies on the line
\[
        3x - 7y  = 3.
\] 

The second tells us that $P$ lies on the circle of radius $\sqrt{145}$ centered at $A(3,5)$, or that 
\[
    \sqrt{(x-3)^2 + (y-5)^2} = \sqrt{145} .
\]


So we can find the possible coordinates of $P$ by using algebra to find the coordinates of the points where the line and circle intersect. For this, we solve the equation
\[
    3x - 7y = 3
\]
for $x$ to get
\[ 
        x = 1 + \frac{7}{3}y .
\]
Substitute this expression into the equation of the circle and square both sides to get
\[
   \left( \frac{7}{3}y - 2 \right)^2 + (y-5)^2 = 145.
\]
Then square both terms on the left and simplify, giving
\[
    \frac{58}{9}y^2 - \frac{58}{3}y - 116 = 0 ,
\]
or
\[
       y^2 - 3y - 18 = 0 . 
