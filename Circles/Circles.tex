...
\begin{explanation}
(a) This smallest circle through $A(3,5)$ and $B(6,-2)$ is centered at the midpoint $M$ of segment $\overline{AB}$ and has coordinates $(\answer{9/2}, \answer{3/2})$. The radius of the circle is half the diameter $AB$ and is equal to
\[
        \frac{1}{2} \answer{\sqrt{58}} .
\]
