...
\]
Next we'll subtract $169$ from both sides and then multipy both sides by $10$, giving
\[
...
\]
Comparing the second terms in the this expression ($20cx$) with the second term in the left side of the previous equation ($780x$) tells us that 
\[
     20c = \answer{780} 
\]
and
...
to get
\[
  100x^2 + 780x + \answer{39^2} = \answer{-1440} + \answer{39^2} .
\]
...
\]
To find the $y$-coordinates of these intersection points, we substitute these $x$-coordinates into the equation $y=\answer{3x+13}$of the line through the points of intersection. So if $x=-4.8$, then
\[
...
So the circles $x^2 + y^2 = 25$ and $(x+6)^2+(y-2)^2=13$ intersect in the points with coordinates $(-4.8,\answer{-1.4})$ and $(-3, \answer{4})$.
...
\section*{Circles Tangent to Each Other}
