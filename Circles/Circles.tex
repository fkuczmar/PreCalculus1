...
Use algebra to find the exact coordinates of the two intersection points. Do this as follows:

(a) Solve the equation of the line $y - 3x = 13$ for $y$ in terms of $x$. Then substitute this expression into the equation
\[
   x^2 + y^2 = 25
\]
of the first circle to get a quadratic equation. Solve this resulting equation for $x$ by \emph{completing the square}. Do {\bf not} use the quadratic formula.
