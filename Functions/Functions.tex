...
Make up at least three questions of the kind in Example 4 for this scenario. Use the graph of the function to find approximate answers/solutions to each question. Be sure to translate your question from math to English first
